      ...
      <div className="container1">
        <div className="header-content1">
          <div className="header-brand1">
            <Link to="/home" className="brand-link1">
          ...
          <div className="header-nav-container1">
            <nav className="header-nav1">
              <ul className="nav-links1">
                ...
                <li>
                  <Link to="/#services" onClick={(e) => scrollToSection(e, "services")}>
                    Nos services
                  </Link>
                </li>
                <li>
            ...
            <div className="auth-buttons1">
              <Link to="/dashboard" className="btn btn-profile">
                <FaUserCircle size={24} /> {/* Icône de profil */}
              </Link>
            </div>
          </div>
        </div>
